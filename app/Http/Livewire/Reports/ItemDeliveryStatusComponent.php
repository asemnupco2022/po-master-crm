...
use App\Models\ItemDeliveryStatusRepo;
use Carbon\Carbon;
...
class ItemDeliveryStatusComponent extends Component
{
    use WithPagination;
    ...
    public $columns=ItemDeliveryStatusRepo::CONS_COLUMNS;
    ...
    public function export_data($type)
    {
        ...
        // $collection = ItemDeliveryStatusRepo::whereIn('id',$selectedRows)->select($ColKeys)->get();
    ...
    protected function filterForExport($ColKeys){
        $query=ItemDeliveryStatusRepo::orderBy('tender_no', 'ASC');
    ...
    public function render()
    {
        ...
        return view('livewire.reports.item-delivery-status-component')->with('collections', $collections);
    }
}
